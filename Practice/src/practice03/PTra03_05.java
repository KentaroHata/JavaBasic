...
public class PTra03_05 {
	public static void main(String[] args) {
		 ...
		 * ※ プログラムは何行書いても良いです
		 */
		if(num>=100) {System.out.println("「不正な値が入力されました」");
		}else if(num>=75) {System.out.println("「雨が降る確率が高いです」");
		}else if(num>=30) {System.out.println("「雨が振るかもしれないです」");
		}else if(num>=0) {System.out.println("「雨はまず降らないでしょう」");
		}else if(num<0) {System.out.println("「不正な値が入力されました。」");
		}
		}
}
